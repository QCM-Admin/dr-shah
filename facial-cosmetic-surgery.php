...
<body class="content-page">
    ...
    <!-- Header -->
    <header id="top" class="hero-content-header header-facial-cosmetic-surgery">
      <?php
        //Brand Panel
        include ('controls/facial-cosmetic-surgery/page-header.php');
        //<!-- Navigation Desctop -->
  ...
  <div class="layout">
      <?php
        //Projects
        include ('controls/facial-cosmetic-surgery/projects.php');
        //<!-- Contacts -->
