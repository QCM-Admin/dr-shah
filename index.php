  ...
  <div class="layout">
          ...
          <ul>
            ...
            <li  data-transition="slotzoom-horizontal" data-slotamount="7" data-masterspeed="1000" data-fsmasterspeed="1000">
              ...
              <div class="slide-title tp-caption tp-resizeme"
                ...
                data-elementdelay="0.05">Meet Dr. Bharat Shah
              </div>
              ...
              <div class="slide-subtitle tp-caption tp-resizeme"
                ...
                data-start="1500"
                data-splitin="none"
                data-splitout="none">Board Certified Plastic Surgeon<br>
                "The Same you<br>
                Only Better."
              </div>
            ...
            <li data-transition="slotzoom-horizontal" data-slotamount="7" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1000">
              ...
              <img src="img/slider/slide2.jpeg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
              ...
              <div class="slide-title tp-caption tp-resizeme"
                ...
                data-splitout="none"
                data-responsive_offset="on"
                data-elementdelay="0.05">Visit Our Online Store
              </div>
              ...
              <div class="slide-subtitle tp-caption tp-resizeme"
                ...
                data-splitin="none"
                data-splitout="none">
                View the latest Skin Care Products proven to diminish the appearance of aging.<br>
                Our Online Store has our latest products and special pricing.<br>
                Includes <strong>FREE 2 Day Shipping</strong> on all orders!
              </div>
            ...
            <li data-transition="slotzoom-horizontal" data-slotamount="7" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1000">
              ...
              <div class="slide-title tp-caption tp-resizeme"
                ...
                data-splitout="none"
                data-responsive_offset="on"
                data-elementdelay="0.05">– Bharat Shah, MD
              </div>
              ...
              <div class="slide-subtitle tp-caption tp-resizeme"
                ...
                data-start="1500"
                data-splitin="none"
                data-splitout="none">“Plastic surgery is the perfect blend of surgery,<br>
                science and art. I enjoy seeing the changes that I<br>
    ...
    <div class="content">
      ...
      <section id="about" class="about section">
        <div class="container">
          <header class="section-header">
            <h2 class="section-title">About <span class="text-primary">Dr. Bharat Shah</span></h2>
          ...
          <div class="section-content">
            <div class="row-base row">
              <div class="col-base col-sm-6 col-md-4">
                <h3 class="col-about-title"><span class="text-primary">"</span>The Same You...Only Better<span class="text-primary">"</span></h3>
                <div class="col-about-info">
                  <p>Dr. Bharat Shah is a plastic surgeon providing world-class cosmetic treatments at his Springfield, MO, practice. In addition
                     to being a trusted authority on plastic surgery who focuses on breast surgery, facelift, and tummy tuck procedures, he also
                      provides hair restoration and a variety of male plastic surgery treatments. No other practice in the area provides treatments
                       this diverse and comprehensive.</p>
                </div>
              </div>
              <div class="col-base col-about-spec col-sm-6 col-md-4">
                <h3 class="col-about-title">Featured<br> Procedures<span class="text-primary">:</span></h3>
      ...
      <section class="projects section">
        <div class="container">
          <h2 class="section-title">Shah's <span class="text-primary">Procedures</span></h2>
        </div>
        <div class="section-content">
          <div class="projects-carousel js-projects-carousel js-projects-gallery">
            ...
            <div class="project">
              <a href="img/projects/5-480x880.jpg" title="project 6">
                <figure>
            ...
            <div class="project">
              <a href="img/projects/9-480x880.jpg" title="project 8">
                <figure>
                  <img alt="" src="img/projects/9-480x880.jpg">
                  <figcaption>
                    <h3 class="project-title">
                      Blepharoplasty<br> (Brow Lift)
                    </h3>
                    <h4 class="project-category">
                      Facial Cosmetic Surgery
                    </h4>
            ...
            <div class="project">
              <a href="img/projects/10-480x880.jpg" title="project 8">
                <figure>
                  <img alt="" src="img/projects/10-480x880.jpg">
                  <figcaption>
                    <h3 class="project-title">
                      Rhinoplasty<br> (Chin Augmentation)
                    </h3>
                    <h4 class="project-category">
                      Facial Cosmetic Surgery
                    </h4>
      ...
      <section class="experience section">
        <div class="container">
          <div class="text-parallax" data-stellar-background-ratio="0.85" style="background-image: url('img/bg/text-1.jpg');">
            <div class="text-parallax-content">25</div>
          </div>
          <h4 class="experience-info wow fadeInRight"><span class="text-primary">Years of successful work</span><br> in his plastic surgery practice</h4>
        </div>
      </section>
      ...
      <section class="clients section">
        <div class="container">
          <header class="section-header">
            <h2 class="section-title">BOARD CERTIFICATIONS <span class="text-primary">& AFFILIATIONS</span></h2>
            <strong class="fade-title-left">Certifications</strong>
          </header>
          <div class="section-content">
          ...
          <div class="section-content">
            <a href="#" class="btn btn-shadow-2">Free Consultation<i class="icon-next"></i></a>
          </div>
        </div>
      </section>
          ...
          <div class="section-content">
            <div class="row-base row">
              <div class="col-address col-base col-md-4">
                +1 (417) 820-9340<br>
                info@drshah.com<br>
                1229 E Seminole, Ste 310, Springfield, MO 65804
              </div>
      ...
      <!-- Footer -->
      <?php include ('php/global/footer.php');?>
      <!-- Lines -->
      <?php include ('php/global/lines.php');?>
